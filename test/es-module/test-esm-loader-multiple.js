...
const fxtrBase = '../fixtures/es-module-loaders/';
const loader_add_hash = path.join(__dirname, fxtrBase, 'loader-add-hash.mjs');
const loader_remove_params = path.join(
  __dirname,
  fxtrBase,
  'loader-remove-params.mjs'
);
const logger = path.join(__dirname, fxtrBase, 'esm-log-import-url.mjs');
const dependency = path.join(__dirname, fxtrBase, 'esm-export-url.mjs');
